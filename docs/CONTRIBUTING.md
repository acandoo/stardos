...
The recipe will install Gleam and JavaScript dependencies, as well as install hooks to format and test your changes before committing, and install new dependencies on pull. If you don't want the hooks set up, run `just setup-no-hooks`. From there, the other `just` recipes are your friends.
...
Also, please don't have AI write your PR messages! You are responsible for your PRs, so you should be able to describe them. AI-generated descriptions leave a bad taste in the mouth when reading through them and make reviewing contributions more difficult.
